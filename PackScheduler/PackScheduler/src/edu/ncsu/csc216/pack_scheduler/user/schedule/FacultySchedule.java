...
public class FacultySchedule {
	 ...
	 * @throws IllegalArgumentException if the course is already assigned
	 * @throws IllegalArgumentException if the course cannot be assigned due to
	 *                                  conflict
	 * @throws IllegalArgumentException if the course already has an instructor
	 */
