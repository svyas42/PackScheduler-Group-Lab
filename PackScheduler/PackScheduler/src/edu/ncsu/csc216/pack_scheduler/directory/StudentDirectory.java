...
public class StudentDirectory {
	 ...
	 * @throws IllegalArgumentException if we are unable to read the file
	 */
	 ...
	 * @throws IllegalArgumentException if the repeat password does not match
	 */
	public boolean addStudent(String firstName, String lastName, String id, String email, String password, String repeatPassword, int maxCredits) {
		...
		if (maxCredits < 3 || maxCredits > Student.MAX_CREDITS) {
			student = new Student(firstName, lastName, id, email, hashPW, 18);
		} else {
	 ...
	 * @throws IllegalArgumentException if we cannot write the student records to the file
	 */
	...
	/**
	 * Getting the studentDirectory based on the student id's
