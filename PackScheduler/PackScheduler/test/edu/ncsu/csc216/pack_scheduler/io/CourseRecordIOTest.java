...
public class CourseRecordIOTest {
	...
	/** Getting instance of registration manager */
	 ...
	 * @throws IOException if the file to reset cannot be found on the given path
	 */
	@Before
	public void setUp() throws IOException {
		...
		m = RegistrationManager.getInstance();
		m.getFacultyDirectory().loadFacultyFromFile("test-files/faculty_records.txt");
	}	
	...
	public void testReadValidCourseRecords() {
		m = RegistrationManager.getInstance();
		m.getFacultyDirectory().loadFacultyFromFile("test-files/myFaculties.txt");
		try {
