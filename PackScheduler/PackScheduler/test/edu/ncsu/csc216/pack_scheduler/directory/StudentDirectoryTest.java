...
public class StudentDirectoryTest {
	...
	public void testAddStudent() {
		...
		StudentDirectory sd1 = new StudentDirectory();
		String[][] studentDirectory1 = sd1.getStudentDirectory();
		try {
			sd1.addStudent("", LAST_NAME, ID, EMAIL, PASSWORD, PASSWORD, MAX_CREDITS);
			assertEquals(0, studentDirectory1.length);
			
			sd1.addStudent(null, LAST_NAME, ID, EMAIL, PASSWORD, PASSWORD, MAX_CREDITS);
			assertEquals(0, studentDirectory1.length);	
		
			sd1.addStudent(FIRST_NAME, "", ID, EMAIL, PASSWORD, PASSWORD, MAX_CREDITS);
			assertEquals(0, studentDirectory1.length);
		
			sd1.addStudent(FIRST_NAME, null, ID, EMAIL, PASSWORD, PASSWORD, MAX_CREDITS);
			assertEquals(0, studentDirectory1.length);
			
			sd1.addStudent(FIRST_NAME, LAST_NAME, "", EMAIL, PASSWORD, PASSWORD, MAX_CREDITS);
			assertEquals(0, studentDirectory1.length);
			
			sd1.addStudent(FIRST_NAME, LAST_NAME, null, EMAIL, PASSWORD, PASSWORD, MAX_CREDITS);
			assertEquals(0, studentDirectory1.length);
		
			sd1.addStudent(FIRST_NAME, LAST_NAME, ID, "", PASSWORD, PASSWORD, MAX_CREDITS);
			assertEquals(0, studentDirectory1.length);
			
			sd1.addStudent(FIRST_NAME, LAST_NAME, ID, null, PASSWORD, PASSWORD, MAX_CREDITS);
			assertEquals(0, studentDirectory1.length);
			
			sd1.addStudent(FIRST_NAME, LAST_NAME, ID, "sm.vyas@ncsuedu", PASSWORD, PASSWORD, MAX_CREDITS);
			assertEquals(0, studentDirectory1.length);
			
			sd1.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, "pw", "pw13", MAX_CREDITS);
			assertEquals(0, studentDirectory1.length);
		
			sd1.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, "", PASSWORD, MAX_CREDITS);
			assertEquals(0, studentDirectory1.length);
			
			sd1.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, null, PASSWORD, MAX_CREDITS);
			assertEquals(0, studentDirectory1.length);
		
			sd1.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, PASSWORD, 42);
			assertEquals(0, studentDirectory1.length);	
	...
	public void testSaveStudentDirectory() {
		...
		sd.addStudent("Demetrius", "Austin", "daustin", "Curabitur.egestas.nunc@placeratorcilacus.co.uk", "pw", "pw", 18);
		...
		//Adding invalid student
		try {
			StudentDirectory sd1 = new StudentDirectory();
			sd1.addStudent("Holland", "Tom", "tholland", "t.@ncsuedu", "pw", "pw", 5);
			assertEquals(0, sd1.getStudentDirectory().length);
			sd.saveStudentDirectory("test-files/actual_student_records.txt");
			checkFiles("test-files/expected_student_records.txt", "test-files/actual_student_records.txt");
		} catch (IllegalArgumentException e) {
	...
	/**
	 * Tests the getStudentDirectory()
	 */
	@Test
	public void testGetStudentDirectoryById() {
		StudentDirectory sd = new StudentDirectory();
		sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, PASSWORD, MAX_CREDITS);
		sd.addStudent("Holland", "Tom", "tholland", "tholland@ncsu.edu", "pw", "pw", 5);
